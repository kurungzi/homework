...
# 차트 항목 찾기 (가정: HTML 구조가 이런 식으로 되어있다고 가정)
# 실제 HTML 구조에 따라 'tr'와 'td'의 class나 id 속성이 다를 수 있습니다.
chart_rows = soup.find_all('tr', class_='lst50') + soup.find_all('tr', class_='lst100')
